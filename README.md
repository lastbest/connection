...
- 주요 기능 :
  1. Openvidu를 이용해 WebRTC를 구현하여 그룹 화상통화 및 채팅 기능 지원
  2. Tensorflow를 이용한 모션인식을 통해 연결된 사용자들의 화면에 보여지는 효과(폭죽 효과, 가상 케이크 불 끄기)
  3. 음성인식을 통해 특정기능 수행(음악재생 등), 음성변조 기능
  4. 파티 기념사진 촬영 후 앨범에서 다시 조회 가능
